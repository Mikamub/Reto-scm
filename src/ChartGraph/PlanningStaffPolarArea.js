...
function PlaningStaffPolarArea({ selectedValues }){ //props con valores de los selects
    ...
    return (
        <div className='graphPolar'>
            <p>Contratos StaffPlanning</p>
            <PolarArea data={chartData} options={chartOptions} />
        </div>);
};

export {PlaningStaffPolarArea};
